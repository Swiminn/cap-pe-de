...
--training_args="{
    'init_iter': 0, 'max_iter': 20000, 'print_intv': 10,
...
#    'network': 'mmpe_test',
    'network': 'mmpe',
    'network_args': {
        'pretrained': True, 'backbone': 'vit_b_16', 'fmap_ch': 256,
#        'dynamic_ch': 4389,
        'dynamic_ch': 25093,
        'xy_limit_factor': 1.0, 'std_factor': 0.05, 'max_batch_size': 32,
        'hidden_dim': 768, 'patch_size': 16,
    },
}" \
--loss_func_info="{
    'loss_func': 'mmpe',
...
--tester_info_list="[{
    ...
    'tester': 'coco_quant',
    'tester_args': {'annotation_path': '/home/user/Data/coco/annotations/person_keypoints_val2017.json'}
}]" \
